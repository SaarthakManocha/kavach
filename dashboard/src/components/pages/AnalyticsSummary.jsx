...
export default function AnalyticsSummary() {
  ...
  return (
    <div>
      <PageHeader title="Executive Summary" description="Here you will find a high level summary of long term network performance, junction behaviors, and temporal predictions. Think of it as an executive intelligence digest. It translates raw violation data into strategic insights and provides a targeted list of priority actions so you know exactly where to focus your attention." />
