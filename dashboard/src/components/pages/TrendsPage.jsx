...
export default function TrendsPage() {
  return (
    <div>
      <PageHeader title="Violation Trends" description="Dive into an interactive view of historical violation data over time. This is useful for spotting long term seasonal trends and evaluating how effective past traffic interventions have been. By comparing specific zones against the city wide average, you can easily see if congestion is improving or getting worse." />
